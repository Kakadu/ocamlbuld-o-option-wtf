````
➜  ocamlbuild-o-wtf make clean
rm -fr _build program.native
➜  ocamlbuild-o-wtf make
ocamlbuild -use-ocamlfind -classic-display -j 2  \
...
moc src/controller.h > src/moc_controller.c
...
➜  ocamlbuild-o-wtf ocamlc -v
The OCaml compiler, version 4.02.3
Standard library directory: /home/kakadu/.opam/4.02.3/lib/ocaml
````
